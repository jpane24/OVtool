...
#'  \item{sp_sm_3}{Substance Problem Scale, Past Month, recorded at 3-months}
#'  \item{sp_sm_6}{Substance Problem Scale, Past Month, recorded at 6-months}
#'  \item{gvs}{General Victimization Scale}
#'  \item{ers21_0}{Environment Risk Scale, baseline}
#'  \item{nproc}{Count of Treatment A procedures delivered to client}
...
#'  \item{recov_3}{Binary indicator indicating if in recovery, recorded at 3-months}
#'  \item{recov_6}{Binary indicator indicating if in recovery, recorded at 6-months}
