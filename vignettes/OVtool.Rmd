...
The contours shown in Figure 4 are relatively smooth but we would like to smooth them out if possible by simulating our unobserved confounder an additional 50 times. The user can do this by running the following lines of code.
