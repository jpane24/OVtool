...
The contours shown in Figure 4 are relatively smooth but we would like to smooth them out if possible by simulating our unobserved confounder an additional 10 times. The user can specify `more_reps` to any number they choose in the following function call, `add_reps()`.
